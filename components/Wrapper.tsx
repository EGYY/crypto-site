...
import BanAlert from "./Alerts/BanAlert";
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={description ?? "БЛОГ О ZАRАБОТКЕ ZARABARAHOROSHO"}
        />
        <meta
          name="keywords"
          content={keywords ?? "заработок успех бизнес инвестиции"}
        />
        {no_index && (
          <>
